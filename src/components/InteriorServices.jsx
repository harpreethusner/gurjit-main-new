...
import image3 from "../assets/images/BEST-INTERIOR-DESIGNS-01.jpg";
import image7 from "../assets/images/BEST-INTERIOR-DESIGNS-01.jpg";
import image8 from "../assets/images/BEST-INTERIOR-DESIGNS-01.jpg";
...
const InteriorServices = () => {
  ...
  return (
    <div className="font-sans text-gray-800">
      ...
      <div className="h-[60vh] md:h-[70vh] lg:h-[80vh] bg-cover bg-center bg-[url('assets/images/BEST-INTERIOR-DESIGNS-01.jpg')]">
